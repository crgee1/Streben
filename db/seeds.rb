...
ActiveRecord::Base.transaction do
  ...
  user1.photo.attach(io: open('https://streben-dev.s3-us-west-1.amazonaws.com/Hx2xmKENUg72oW2jssiaQiaS'), filename: 'nishikori.jpg')
  user2 = User.create(username: 'Sonic', password: 'password')
  user2.photo.attach(io: open('https://streben-dev.s3-us-west-1.amazonaws.com/EMxG6WL4yKgMTG5GRaMMYvvN'), filename: 'sonic.jpg')
  user3 = User.create(username: 'Kallmeehkev', password: 'password')
  user3.photo.attach(io: open('https://streben-dev.s3-us-west-1.amazonaws.com/pjXdedK2dj4ZVAkffG7f6y7f'), filename: 'crab.jpg')
  user4 = User.create(username: 'JimboJams', password: 'password')
  user4.photo.attach(io: open('https://streben-dev.s3-us-west-1.amazonaws.com/ZAwHCtuFLahdUKNbXCaQhGCo'), filename: 'jimbo.jpg')
  user5 = User.create(username: 'SoapyRedPanda', password: 'password')
  user5.photo.attach(io: open('https://streben-dev.s3-us-west-1.amazonaws.com/c29TTykFbzb24L88N7beUVPU'), filename: 'panda.jpg')
  ...
  Like.destroy_all
  Like.create(user_id: user1, workout_id: workout4.id)
  Like.create(user_id: user1, workout_id: workout5.id)
  Like.create(user_id: user1, workout_id: workout5.id)
  Like.create(user_id: user1, workout_id: workout7.id)
  Like.create(user_id: user1, workout_id: workout8.id)
  Like.create(user_id: user1, workout_id: workout9.id)
  Like.create(user_id: user2, workout_id: workout1.id)
  Like.create(user_id: user3, workout_id: workout1.id)
  Like.create(user_id: user4, workout_id: workout1.id)
  Like.create(user_id: user5, workout_id: workout1.id)
  Like.create(user_id: user4, workout_id: workout3.id)
  Like.create(user_id: user2, workout_id: workout3.id)
  Like.create(user_id: user2, workout_id: workout2.id)

  Comment.destroy_all
  Comment.create(user_id: user3, workout_id: workout2, body:"We should run together")
  Comment.create(user_id: user1, workout_id: workout2, body:"Yeah, next time")
  Comment.create(user_id: user4, workout_id: workout2, body:"Me too")
  Comment.create(user_id: user1, workout_id: workout4, body:"That's pretty fast")
  Comment.create(user_id: user2, workout_id: workout4, body:"Gotta Go Fast!")
  Comment.create(user_id: user1, workout_id: workout6, body:"Are you training for anything?")
end
